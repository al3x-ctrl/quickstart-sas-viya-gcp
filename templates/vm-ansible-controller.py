...
###################################
git clone https://github.com/al3x-ctrl/quickstart-sas-viya-gcp $INSTALL_DIR
...
###################################
git clone https://github.com/al3x-ctrl/quickstart-sas-viya-common-gcp $INSTALL_DIR/common
